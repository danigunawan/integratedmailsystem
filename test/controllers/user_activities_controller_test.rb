...
class UserActivitiesControllerTest < ActionController::TestCase
  ...
  test "should create user_activity" do
    assert_difference('UserActivity.count') do
      post :create, user_activity: { action: @user_activity.action, activity: @user_activity.activity, controller: @user_activity.controller, time: @user_activity.time, username: @user_activity.username }
    end
  ...
  test "should update user_activity" do
    patch :update, id: @user_activity, user_activity: { action: @user_activity.action, activity: @user_activity.activity, controller: @user_activity.controller, time: @user_activity.time, username: @user_activity.username }
    assert_redirected_to user_activity_path(assigns(:user_activity))
  end
